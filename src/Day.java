...
public class Day extends javax.swing.JFrame {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {// GEN-FIRST:event_formWindowOpened
        ...
        /*
         * First column is ExpID which makes updating and removing records easier and is
         * to be kept hidden
         * due to records being not in sequence.Removing it from table hides it and
         * does'nt removes it from table model
         */
        ...
        try {
            if (!globalvar.day.equals("not needed")) {
                ...
                Connection c = DriverManager.getConnection("jdbc:mysql://localhost:3306/emp12cay" + globalvar.year,
                        "root", "manas");
        ...
        try {
            Connection c1 = DriverManager.getConnection("jdbc:mysql://localhost:3306/emp12cay" + globalvar.year, "root",
                    "manas");
    ...
    private void dbackActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_dbackActionPerformed
        ...
        try {
            ...
            if (globalvar.isMonthlyExpensesBeingShown.equals("Yes")) {
                ...
                ResultSet r = daynm
                        .executeQuery("select dayname('" + globalvar.year + "-" + a + "-" + day + "') as d;");
                if (r.next()) {
