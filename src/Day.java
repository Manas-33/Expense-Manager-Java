...
try{
    ...
    Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/emp12cay" + globalvar.year,"root","manas");
    int daychk = 1;
    while(daychk<=31){
...
JOptionPane.showMessageDialog(rootPane, e.getMessage());
    ...
    try{
        Connection c1 = DriverManager.getConnection("jdbc:mysql://localhost:3306/emp12cay"+globalvar.year,"root","manas");
